...
export default function EnhancedLiveChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: '🙏 नमस्ते! मैं SUMIT ASSISTANT हूं - आपका विशेषज्ञ डिजिटल सहायक!\n\n🎯 मैं आपकी मदद कर सकता हूं:\n\n📋 सरकारी सेवाएं:\n✓ आधार, PAN, वोटर ID, राशन कार्ड\n✓ पासपोर्ट, ड्राइविंग लाइसेंस\n✓ सभी प्रकार के सर्टिफिकेट\n✓ छात्रवृत्ति आवेदन\n\n💰 बैंकिंग सेवाएं:\n✓ AEPS, मनी ट्रांसफर\n✓ बिल पेमेंट, रिचार्ज\n✓ बैंक खाता खोलना\n✓ लोन आवेदन\n\n🎓 परीक्षा सेवाएं:\n✓ सरकारी नौकरी आवेदन\n✓ एडमिट कार्ड, रिजल्ट\n✓ प्रवेश फॉर्म\n\n✈️ यात्रा सेवाएं:\n✓ ट्रेन, बस, फ्लाइट टिकट\n✓ होटल बुकिंग\n\n🖨️ प्रिंटिंग सेवाएं:\n✓ डॉक्यूमेंट प्रिंटिंग\n✓ फोटोकॉपी, लैमिनेशन\n✓ पासपोर्ट फोटो\n\n💻 कंप्यूटर ट्रेनिंग:\n✓ बेसिक से एडवांस कोर्स\n✓ इंटरनेट सेवाएं\n\n📞 संपर्क करें:\n✓ फोन: +91 9306003497\n✓ WhatsApp: +91 98765 43210\n✓ Email: sumit03497@gmail.com\n✓ पता: VPO DANG KALAN NEAR BAWEJA MART\n\nआप मुझसे हिंदी या English में बात कर सकते हैं। कैसे मदद करूं? 😊',
      sender: 'admin',
      timestamp: new Date()
    }
  ]);
